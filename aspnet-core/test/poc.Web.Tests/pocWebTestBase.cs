...
{
    public abstract class pocWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static pocWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(pocWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<pocDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<pocDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<pocDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<pocDbContext, Task<T>> func)
        {
            T result;
